...
#ifndef HARLEY_QUINN_H
#define HARLEY_QUINN_H
...
/* Lv.3 小丑女[攻击]
   指定一名对手，向他宣言一张牌的名称，若对手的手牌拥有该牌，将其丢弃；若带有 Lv，你 +1 金币。
*/
bool HarleyQuinn(
...
int calc_using_pref_harley_quinn(int          arg_player,
							HTBasicData& arg_global_data,
							HTBasicFunc& arg_basic_func);

#endif // HARLEY_QUINN_H
